...
This policy covers the contents of this repository: the self-hosted deployment code (`deploy/`), contribution templates, metadata schemas, CI workflows, and community documentation.
